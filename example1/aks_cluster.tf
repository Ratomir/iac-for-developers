resource "azurerm_kubernetes_cluster" "aks" {
  ...
  node_resource_group = "rg-aks-node-${var.project_name}-${var.env}"
...
data "azurerm_user_assigned_identity" "kvcsi" {
  name                = "azurekeyvaultsecretsprovider-aks-${var.project_name}-${var.env}"
  resource_group_name = "rg-aks-node-${var.project_name}-${var.env}"
  depends_on = [
